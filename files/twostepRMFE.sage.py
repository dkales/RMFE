...
_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4)#!/usr/bin/env sage
...
def phi_RMFE(v,instance):
	...
	w.append(v[k*(number_blocks-_sage_const_1 ):]+[_sage_const_0 ]*(k*number_blocks-len(v)))
